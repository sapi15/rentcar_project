  ...
  <DIV class='content_body'>
    ...
    <input type='hidden' name='memberno' id='memberno' value='${param.memberno }'>  
      <div class="form-group">
        ...
        <div class="col-md-7">
          <input type="text" class="form-control" name='mname' id='mname' value='${memberVO.mname }' style='width: 10%;' readonly="readonly">
        </div>
      </div>   
      ...
      <div class="form-group">
        ...
        <div class="col-md-7">
          <input type="text" class="form-control" name='id' id='id' value='${memberVO.id }' style='width: 10%;' readonly="readonly">
        </div>
      </div>  
     ...
     <div class="form-group">
        ...
        <div class="col-md-7">
          <input type='password' class="form-control" name='passwd' 
                    id='passwd' value='' required="required" autofocus="autofocus"
                    style='width: 20%;' placeholder="패스워드">
        </div>
      </div>  
      
      <div class="form-group">
        <div class="col-md-offset-5 col-md-7">
          <button type="submit" id='btn_send' class="btn btn-primary">탈퇴하기</button>
