...
<DIV class='title_line'>
  ...
  <A href="./list_by_rentcargrpno_search_paging.do?now_page=1&rentcargrpno=${rentcargrpVO.rentcargrpno }" 
   ...
   <c:choose>
    ...
    <c:forEach var="rentVO" items="${list}" varStatus="status">
      ...
      <tr> 
            ...
            <td style='vertical-align: middle;  text-align: center;'>
              <a href="./read.do?rentno=${rentno}&now_page=${param.now_page }"><strong>${maker} ${carname}</strong><br>${contents }</a> 
            </td>
            
            <td style='vertical-align: middle;  text-align: center;'>
              <p>평일 24시간: <fmt:formatNumber value="${normal_price}" pattern="#,###"></fmt:formatNumber></p>
              <p>주말 24시간: <fmt:formatNumber value="${weekend_price}" pattern="#,###"></fmt:formatNumber></p>
            </td>
