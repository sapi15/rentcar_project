...
<DIV class='content_body'>
  <DIV id='panel_create' style='padding: 10px 0px 10px 0px; background-color: #F9F9F9; width: 100%; text-align: center;'>
    <FORM name='frm_create' id='frm_create' method='POST' action='./create.do'>
      ...
      <label>카테고리</label>
      <input type='text' name='cate' value='' required="required" style='width: 10%;'
                 autofocus="autofocus">
  ...
  <TABLE class='table table-striped'>
    ...
    <c:forEach var="rentcargrpVO" items="${list}">
      ...
      <TR>
        ...
        <TD class="td_bs">
        <A href="../rent/list_by_rentcargrpno_search_paging.do?word=&now_page=1&rentcargrpno=${rentcargrpno }">${rentcargrpVO.cate }</A>
        </TD>
  ...
  <div style="text-align: right; padding: 10px;"> 
     <button type='button' onclick="location.href='../rent/list_all_join_search_paging.do'" class="btn btn-primary">전체목록</button>
  </div>
</DIV>
