...
alter table rent
add (normal_price int(10) default 0);

alter table rent
add (weekend_price int(10) default 0);
...
VALUES(3, 1, '기아', 'K5', '중형', '1.6가솔린 터보', '가솔린', '180hp', '1,600cc', '13.2~13.8km/ℓ', 'car.jpg', 'car_1.jpg', 'car_t.jpg', 
       1000, 'maker.jpg', 'maker_1.jpg', 'maker_t.jpg', 300, 'K5, 중형', '중형세단', NOW(), '1234', '0', '0', '0')
...
VALUES(3, 1, '기아', '쏘렌토', '중형', '1.6터보HEV', '하이브리드, 가솔린', '230hp', '1,600cc', '14.3~15.3km/ℓ', 'car.jpg', 'car_1.jpg', 'car_t.jpg', 
       1000, 'maker.jpg', 'maker_1.jpg', 'maker_t.jpg', 300, '쏘렌토, 중형', '중형suv', NOW(), '1234', '0', '0', '0')       
...
-- 전체 목록(join)
SELECT i.rentno, i.rentcargrpno, i.adminno, i.maker, i.carname, i.kind, i.model, i.fuel, i.hp, i.cc, i.mileage, i.recom,
